...
import br.edu.infnet.pos.java.trabalhodebloco.dominio.entidades.pesquisa.util.JsfUtil;
import br.edu.infnet.pos.java.trabalhodebloco.dominio.entidades.pesquisa.util.PaginationHelper;
...
public class RespostaController implements Serializable {
    ...
    @EJB
    private br.edu.infnet.pos.java.trabalhodebloco.dominio.entidades.pesquisa.RespostaFacade ejbFacade;
    ...
    private RespostaFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (Resposta) getItems().getRowData();
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("RespostaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class RespostaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            RespostaController controller = (RespostaController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "respostaController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Resposta) {
                ...
                return getStringKey(o.getIdResposta());
            } else {
