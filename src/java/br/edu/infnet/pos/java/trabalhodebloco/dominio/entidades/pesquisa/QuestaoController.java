...
public class QuestaoController implements Serializable {
    ...
    @EJB
    private br.edu.infnet.pos.java.trabalhodebloco.dominio.entidades.pesquisa.QuestaoFacade ejbFacade;
    ...
    public SelectItem[] getItemsAvailableSelectMany() throws IllegalArgumentException, IllegalAccessException {
        return JsfUtil.getSelectItems(ejbFacade.findAll(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() throws IllegalArgumentException, IllegalAccessException {
     ...
     public String getItemsAvailableSelectOne1() {
         
        Questao  q = new Questao(); 
         
        return JsfUtil.getRequestParameter(q.getTexto());
     }
